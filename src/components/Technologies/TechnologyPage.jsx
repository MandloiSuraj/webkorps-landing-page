...
import { IndustryChallenges } from '../sharedComponents/IndustryChallenges';
...
const TechnologyPage = ({
    ...
    return (
        <div className="w-full text-center xl:text-left ipad-pro:text-left md:text-center  pt-[80px]">
            ...
            {features &&
                <div className=" py-[4rem]   bg-custom-blue-gradient font-inter  relative  xl:overflow-visible ipad-pro:overflow-visible overflow-hidden">
                    <div className="bg-white mx-[7%] md:mx-[7%] xl:mx-[50px] ipad-pro:mx-[50px] justify-center  shadow-custom-lg rounded-[20px] z-10 font-inter xl:overflow-visible ipad-pro:overflow-visible overflow-hidden">
                        ...
                        <div className="flex xl:flex-row md:flex-row ipad-pro:flex-col flex-col items-start gap-x-[45px] px-[3%] xl:px-[30px] ipad-pro:px-[30px]  py-[4rem]">
            ...
            {services &&
                <div className=" py-[4rem]  bg-white font-inter  relative  overflow-hidden">
                    <div className="Clients  w-auto items-center justify-center text-center lg:text-left  mx-[7%] md:mx-[7%] xl:mx-[50px] ipad-pro:mx-[50px] justify-center  shadow-custom-lg rounded-[20px] bg-white ">
                        <div className="w-full text-center px-[3%] xl:px-[30px] ipad-pro:px-[30px] pt-[4rem]" data-aos="fade-up">
                        ...
                        <div className="relative px-[3%] xl:px-[30px] ipad-pro:px-[30px] text-center flex pb-[4rem] pt-[4rem]">
            ...
            {ProcessData && <ProgressSection steps={ProcessData?.steps} steps1={ProcessData?.steps1} title={ProcessData?.title} subtitle={ProcessData?.subtitle} description={ProcessData?.description} centerHeading={true} bgColor='bg-white' processImage={ProcessData?.Processimage} />}



            {industries && <IndustrySection title={industries?.title} description={industries.description} industries={industries.data} centerHeading={true} bgColor='bg-custom-blue-gradient' />}
            {challenges &&
                <IndustryChallenges challenges={challenges?.challengesData} description={challenges?.description} heading={challenges.heading} bgColor={'bg-white'} hiring={false} />
            }
