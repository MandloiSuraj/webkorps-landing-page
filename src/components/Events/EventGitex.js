...
function EventGitex() {
    const endDate = "2025-10-13T23:59:59";
    ...
    const formattedDate = (
        <>
            13<sup>th</sup> to 17<sup>th</sup> October 2025
        </>
    );
    const BtnLink = "https://calendly.com/webkorpsllc/meet-webkorps-at-gitex-dubai";
    const timerDisplay = (
        <span>
    ...
    const whyStandsOutData = [
        ...
        { icon: faBolt, title: "Growth Through Collaboration", description: "We believe innovation is best achieved together. At GITEX, we’re here to collaborate, co-create, and explore new possibilities with you." },
    ];
    ...
    const OverviewData = [
        {
            para:
                "Webkorps is all set to make an impactful presence at GITEX GLOBAL 2025 in Dubai, and we couldn’t be more excited!",
        },
        {
            para:
                "With renewed energy and a passion for innovation, our team is geared up to showcase a powerful suite of smart services and next-gen digital solutions designed to drive transformation across industries.",
        },
        {
            para:
                "At GITEX, we’ll be unveiling how our cutting-edge offerings in AI & Automation, Cloud & DevOps, Custom Software Development, Mobile App Development, Web Development, Cybersecurity, and Data Analytics are solving real-world business challenges and enabling enterprises to scale with confidence.",
        },
        {
            para:
                "Whether you're a startup looking to build fast, a growing business ready to modernize, or an enterprise seeking digital maturity, Webkorps has the experience, expertise, and execution model to accelerate your journey.",
        },
    ];
    ...
    const AboutData = [
        {
            para:
                "GITEX GLOBAL 2025 is more than just a technology exhibition - it's a global celebration of innovation, vision, and progress. As one of the most anticipated and influential tech events in the world, GITEX brings together the brightest minds, pioneering companies, government leaders, and industry disruptors from across the globe.",
        },
        {
            para:
                "The event serves as a launchpad for next-gen technologies, groundbreaking solutions, and future-ready digital strategies. From AI and cybersecurity to cloud computing, blockchain, 5G, IoT, and beyond, GITEX is where tomorrow’s tech is experienced today.",
        },
        {
            para:
                "For Webkorps, GITEX is not just an opportunity to showcase what we’ve built - it’s where we collaborate, exchange ideas, and co-create solutions that empower businesses to thrive in an ever-evolving digital world.",
        },
    ];
    ...
    return (
        <div className="overflow-hidden font-inter">
            <Helmet>
                <title>Meet Webkorps at GITEX Global 2025</title>
                <meta name="description" content="Join Webkorps at GITEX GLOBAL 2025 in Dubai to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta property="og:url" content="https://www.webkorps.com/event/gitex-dubai" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Meet Webkorps at GITEX Global 2025" />
                <meta property="og:description" content="Join Webkorps at GITEX GLOBAL 2025 in Dubai to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta property="og:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/meet-webkorps-at-gitex.jpg" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:domain" content="webkorps.com" />
                <meta property="twitter:url" content="https://www.webkorps.com/event/gitex-dubai" />
                <meta name="twitter:title" content="Meet Webkorps at GITEX Global 2025" />
                <meta name="twitter:description" content="Join Webkorps at GITEX GLOBAL 2025 in Dubai to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta name="twitter:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/meet-webkorps-at-gitex.jpg" />
                <link data-rh="true" rel="canonical" href="https://www.webkorps.com/event/gitex-dubai" />
            </Helmet>
            <div className="w-full text-center xl:text-left ipad-pro:text-left md:text-center ">
                <EventHeroSectionUI
                    title={'Meet Webkorps At Gitex Dubai 2025'}
                    subtitle={"The World’s Largest Tech, AI & Startup Show"}
                    date={formattedDate}
                    location={`Dubai World Trade Centre`}
                    image={'https://webkorps-app.s3.us-east-1.amazonaws.com/webkorps-at-gitex.jpg'}
                    buttonText={'Schedule a meeting'}
                    imageAlt={'webkorps at gitex'}
                    link={BtnLink}
                    height={'h-[65rem]'}
                    timer={timerDisplay}
                />
                ...
                <div className="flex flex-col overflow-hidden md:flex-col ipad-pro:flex-row xl:flex-row items-center xl:items-stretch px-[3%] xl:px-[30px] ipad-pro:px-[30px] justify-center text-center lg:text-left  mx-[7%] md:mx-[7%] xl:mx-[50px] ipad-pro:mx-[50px] justify-center p-12 shadow-custom-lg rounded-[20px] bg-white gap-[60px]">
                    ...
                    <div className="content flex flex-col">
                        <h2
                            ...
                            data-aos="fade-right"
                            dangerouslySetInnerHTML={{ __html: "Webkorps is Ready for GITEX GLOBAL 2025 - Dubai" }}
                        >
                    ...
                    <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                        <img
                            ...
                            loading="lazy"
                            src='https://webkorps-app.s3.us-east-1.amazonaws.com/webkorps-is-ready-for-gitex.jpg'
                            alt="webkorps is ready for gitex"
                    ...
                    <div className="flex overflow-hidden flex-col ipad-pro:flex-row  md:flex-col xxl:gap-[10%] xl:gap-[125px] md:gap-[30px]  xl:flex-row items-start md:items-start ">
                        <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                            <img
                                ...
                                sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 33vw"
                                loading="lazy"
                                src='https://webkorps-app.s3.us-east-1.amazonaws.com/shaping-the-future-at-gitex.jpg'
                                alt="shaping the future at gitex"
                                className="rounded-lg shadow-md w-full lg:w-[385px] h-full max-w-md"
                                data-aos="fade-left"
                            />
                        </div>
            ...
            <div className="w-full flex flex-col items-center justify-center py-12 bg-white px-[7%] md:px-[7%] xl:px-[50px]">
                <div className="flex flex-col items-center justify-center text-center  p-12 shadow-custom-lg rounded-[20px] bg-white ">
                    <div className="content  w-full  text-[#292E3D]">
                        ...
                        >
                            The Value Webkorps Brings to GITEX GLOBAL 2025
                        </h2>
                    </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-8 shadow-custom-lg rounded-[20px] bg-white">
                    <div className="content mx-auto w-full  text-[#292E3D]">
                        ...
                        >
                            What We’re Showcasing at <span className="text-[#1887C9]">GITEX</span>
                        </h2>
                    </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-12 shadow-custom-lg rounded-[20px] bg-white gap-y-8">
                    <h2 className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                    >
                        Why Meet Webkorps at <span className="text-[#1887C9]">GITEX GLOBAL 2025?</span>
                    </h2>
                    ...
                    <p className="max-w-3xl mx-auto text-gray-700 text-lg font-semibold ">
                        Meet us at GITEX 2025 to explore how we can help your business scale, innovate, and lead with confidence.
                    </p>
                    <a
                        href={BtnLink}
                        target="_blank"
