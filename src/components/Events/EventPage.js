...
function EventPage() {
    const endDate = "2026-01-06T23:59:59";
    ...
    const formattedDate = (
        <>
            6<sup>th</sup> to 9<sup>th</sup> January 2026
        </>
    );
    const BtnLink = "https://calendly.com/webkorpsservices/ces";
    const timerDisplay = (
        <span>
    ...
    // What We're Showcasing at INBOUND 2025
    ...
    // Why Meet Webkorps at INBOUND 2025
    const statsData = [
    ...
    const whyMeetFeatures = [
        { icon: faCheckCircle, title: "ISO 9001:2015 & ISO 27001 Certified", description: "We follow the highest standards of quality and data security, ensuring enterprise-grade excellence in everything we deliver." },
        { icon: faCheckCircle, title: "8+ Years of Proven Expertise", description: "A trusted partner in delivering cutting-edge IT solutions tailored to real-world business challenges." },
        { icon: faCheckCircle, title: "Team of 250+ Skilled Professionals", description: "A strong in-house team of experienced developers, engineers, and consultants driving results through innovation." },
        { icon: faCheckCircle, title: "500+ Successful Projects Delivered", description: "From idea to execution, we’ve helped hundreds of businesses turn their vision into reality." },
        { icon: faCheckCircle, title: "Global Reach, Local Understanding", description: "With clients in 30+ countries, we blend global capabilities with regional insights." },
        { icon: faShieldAlt, title: "Recognized by Leading Industry Platforms", description: "Rated highly on Clutch, GoodFirms, TopDevelopers, TechBehemoths, and more." },
        { icon: faCheckCircle, title: "Serving Startups, SMBs & Enterprises Alike", description: "Scalable solutions tailored for businesses of all sizes and stages." },
        { icon: faShieldAlt, title: "Built on Innovation, Reliability & Client Success", description: "We’re committed to long-term partnerships and measurable impact." },
    ];
    // Why Webkorps Stands Out at INBOUND 2025
    const whyStandsOutData = [
        { icon: faBullseye, title: "Precision with Purpose", description: "We develop custom-built solutions that address complex business challenges with clarity, agility, and measurable outcomes." },
        { icon: faUsers, title: "Strategic Partnerships", description: "We don’t just deliver services - we build lasting partnerships that foster mutual growth and long-term success." },
        { icon: faBrain, title: "Future-Ready Expertise", description: "By staying ahead of the curve on emerging technologies, we help businesses adapt, innovate, and lead in rapidly changing markets." },
        { icon: faStar, title: "Proven Excellence", description: "Our portfolio is backed by 500+ successful projects, showcasing our ability to transform ideas into scalable, high-impact solutions." },
        { icon: faBolt, title: "Growth Through Collaboration", description: "We believe innovation is best achieved together. At CES, we’re here to collaborate, co-create, and explore new possibilities with you." },
    ];
    ...
    const OverviewData = [
        {
            para:
                "With a renewed vision and an innovation-first mindset, our team is ready to showcase an advanced suite of intelligent technologies and future-ready digital solutions crafted to redefine how businesses operate, scale, and succeed.",
        },
        {
            para:
                "At CES 2026, we’ll be unveiling how our cutting-edge capabilities across AI & Automation, Cloud & DevOps, Custom Software Development, Mobile App Development, Web Development, Cybersecurity, and Data Analytics are enabling organizations to embrace the future with confidence.",
        },
        {
            para:
                "From groundbreaking prototypes to enterprise-grade digital ecosystems, our solutions are designed to address real-world challenges and unlock new opportunities across industries.",
        },
        {
            para:
                "Whether you're an emerging startup building for speed, a mid-sized business looking to modernize, or a global enterprise aiming for technological excellence, Webkorps brings the expertise, innovation, and execution strength to accelerate your digital transformation journey. Meet us at CES 2026 and experience what's next.",
        },
    ];
    ...
    const AboutData = [
        {
            para:
                "CES 2026 is not just a global technology exhibition - it’s the epicenter of innovation, imagination, and breakthrough advancements. As one of the most influential and iconic tech events on the planet, CES brings together visionary leaders, industry giants, next-gen startups, investors, and innovators who are shaping the world of tomorrow.",
        },
        {
            para:
                "From cutting-edge consumer electronics to transformative enterprise technologies, CES 2026 serves as the global launchpad for the innovations that will define the future. Whether it’s AI-driven intelligence, cybersecurity advancements, cloud ecosystems, robotics, immersive experiences, mobility, smart cities, or digital health, CES is where the world experiences what’s next, long before it reaches the mainstream.",
        },
        {
            para:
                "For Webkorps, CES 2026 is more than a platform to showcase our technological advancements - it’s a place to engage, collaborate, and co-create with global thinkers and innovators. It’s where we demonstrate how our future-ready digital solutions empower businesses to evolve, scale, and excel in an ever-accelerating digital era.",
        },
    ];
    ...
    return (
        <div className="overflow-hidden font-inter">
            <Helmet>
                <title>Meet Webkorps At CES 2026</title>
                <meta name="description" content="Join Webkorps at CES 2026 in Las Vegas to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta property="og:url" content="https://www.webkorps.com/event/ces" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Meet Webkorps At CES 2026" />
                <meta property="og:description" content="Join Webkorps at CES 2026 in Las Vegas to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta property="og:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/Webkorps-is-all-set-to-make-a-powerful-impact-at-CES-in-Las-Vegas.jpg" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:domain" content="webkorps.com" />
                <meta property="twitter:url" content="https://www.webkorps.com/event/ces" />
                <meta name="twitter:title" content="Meet Webkorps At CES 2026" />
                <meta name="twitter:description" content="Join Webkorps at CES 2026 in Las Vegas to experience innovation in action. Discover cutting-edge IT solutions, explore tech trends, and connect with our experts to shape the future of digital transformation." />
                <meta name="twitter:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/Webkorps-is-all-set-to-make-a-powerful-impact-at-CES-in-Las-Vegas.jpg" />
                <link data-rh="true" rel="canonical" href="https://www.webkorps.com/event/ces" />
            </Helmet>
            <div className="w-full text-center xl:text-left ipad-pro:text-left md:text-center ">
                <EventHeroSectionUI
                    title={'Meet Webkorps At CES 2026'}
                    subtitle={"The world’s most powerful tech event"}
                    date={formattedDate}
                    location={`Las Vegas, NV`}
                    image={'https://webkorps-app.s3.us-east-1.amazonaws.com/Webkorps-is-all-set-to-make-a-powerful-impact-at-CES-in-Las-Vegas.jpg'}
                    buttonText={'Schedule a meeting'}
                    imageAlt={'webkorps at ces'}
                    link={BtnLink}
                    height={'h-[65rem]'}
                    timer={timerDisplay}
                />
                ...
                <div className="flex flex-col overflow-hidden md:flex-col ipad-pro:flex-row xl:flex-row items-center xl:items-stretch px-[3%] xl:px-[30px] ipad-pro:px-[30px] justify-center text-center lg:text-left  mx-[7%] md:mx-[7%] xl:mx-[50px] ipad-pro:mx-[50px] justify-center p-12 shadow-custom-lg rounded-[20px] bg-white gap-[60px]">
                    ...
                    <div className="content flex flex-col">
                        <h2
                            ...
                            data-aos="fade-right"
                            dangerouslySetInnerHTML={{ __html: "Webkorps is all set to make a powerful impact at CES 2026 in Las Vegas" }}
                        >
                    ...
                    <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                        <img
                            ...
                            loading="lazy"
                            src='https://webkorps-app.s3.us-east-1.amazonaws.com/Webkorps-is-all-set-to-make-a-powerful-impact-at-CES-n-Las-Vegas.jpg'
                            alt="webkorps is ready for cse"
                    ...
                    <div className="flex overflow-hidden flex-col ipad-pro:flex-row  md:flex-col xxl:gap-[10%] xl:gap-[125px] md:gap-[30px]  xl:flex-row items-start md:items-start ">
                        <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                            <img
                                ...
                                sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 33vw"
                                loading="lazy"
                                src='https://webkorps-app.s3.us-east-1.amazonaws.com/About-CES.jpg'
                                alt="shaping the future at ces"
                                className="rounded-lg shadow-md w-full lg:w-[385px] h-full max-w-md"
                                data-aos="fade-left"
                            />
                        </div>
                        ...
                        <div className="  overflow-hidden " >
                            ...
                            <div className="mt-6 xl:text-left ipad-pro:text-left md:text-left md:ml-[45px] ml-0 ipad-pro:ml-0 xl:ml-0  text-center ">
                                <h2
                                    className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                                >
                                    Where the World’s Technology Futures Begin
                                </h2>
            ...
            <div className="w-full flex flex-col items-center justify-center py-12 bg-white px-[7%] md:px-[7%] xl:px-[50px]">
                <div className="flex flex-col items-center justify-center text-center  p-12 shadow-custom-lg rounded-[20px] bg-white ">
                    <div className="content  w-full  text-[#292E3D]">
                        ...
                        >
                            The Value Webkorps Brings to CES 2026
                        </h2>
                    </div>
                    <div className="w-full flex justify-center">
                        <div className="flex flex-wrap justify-center gap-8 max-w-8xl">
                            ...
                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                ...
                                <h3 className="font-bold text-lg mb-2">Tailored Solutions for Real-World Challenges</h3>
                                <p className="text-[#4B5563] text-base">Webkorps designs and delivers smart, scalable solutions that address industry-specific challenges, with a focus on long-term impact and measurable results.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faUsers} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Innovation-Driven Collaboration</h3>
                                <p className="text-[#4B5563] text-base">We believe in co-creating success. Our collaborative approach fuels innovation and drives sustainable digital transformation for partners worldwide.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faBolt} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Strategic Vision Meets Practical Execution</h3>
                                <p className="text-[#4B5563] text-base">At Webkorps, we merge big-picture thinking with actionable solutions to help businesses stay ahead in an ever-evolving digital landscape.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faGlobe} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Proven Global Expertise</h3>
                                <p className="text-[#4B5563] text-base">With a strong presence at international tech platforms like GITEX, CIO News Tech Events, CES, and IndiaSoft, Webkorps brings global insights to every engagement.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faMedal} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Excellence at Every Step</h3>
                                <p className="text-[#4B5563] text-base">From ideation to execution, we empower organizations with future-ready technologies that accelerate growth and enable lasting success.</p>
                            </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-8 shadow-custom-lg rounded-[20px] bg-white">
                    <div className="content mx-auto w-full  text-[#292E3D]">
                        ...
                        >
                            What We’re Showcasing at <span className="text-[#1887C9]">CES</span>
                        </h2>
                    </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-12 shadow-custom-lg rounded-[20px] bg-white gap-y-8">
                    <h2 className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                    >
                        Why Meet Webkorps at <span className="text-[#1887C9]">CES 2026?</span>
                    </h2>
                    ...
                    <p className="max-w-3xl mx-auto text-gray-700 text-lg">
                        At Webkorps, we don’t just build technology - we craft smart, scalable, and secure solutions that empower businesses to lead in the digital age. Whether you're a startup ready to scale or an enterprise seeking digital transformation, Webkorps brings the innovation and execution you need to succeed.
                    </p>
                    ...
                    <p className="max-w-3xl mx-auto text-gray-700 text-lg font-semibold ">
                        Meet us at CES 2026 to explore how we can help your business scale, innovate, and lead with confidence.
                    </p>
                    <a
                        href={BtnLink}
                        target="_blank"
            ...
            <div className="py-[4rem] bg-[#D3D3D3]">
                <div className="mx-[7%] md:mx-[7%] xl:mx-[50px] p-12 shadow-custom-lg rounded-[20px] bg-white text-center">
                    <h2 className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                    >
                        Why Webkorps Stands Out at <span className="text-[#1887C9]">CES 2026</span>
                    </h2>
                    <p className="mt-4 text-lg text-gray-600 max-w-4xl mx-auto">
                        At Webkorps, we blend innovation, deep industry expertise, and an unwavering commitment to excellence to build solutions that drive real-world impact. As we showcase our capabilities at CES 2026, we invite you to discover how our approach doesn’t just meet business needs - it redefines what’s possible in the digital era.                    </p>
                    <div className="w-full flex justify-center mt-8">
                        <div className="flex flex-wrap justify-center gap-8 max-w-8xl">
