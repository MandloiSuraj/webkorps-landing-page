...
import logoImage from '../../assets/images/webkorps-at-inbound.jpg';
...
function EventInbound() {
    const endDate = "2025-09-03T23:59:59";
    ...
    const formattedDate = (
        <>
            3<sup>rd</sup> to 5<sup>th</sup> September 2025
        </>
    );
    const BtnLink = "https://calendly.com/webkorpsservices/meet-webkorps-at-inbound-hubspot-marketing-and-sales-conference";
    const timerDisplay = (
        <span>
    ...
    const whyMeetFeatures = [
        { icon: faCheckCircle, title: "ISO 9001:2015 & ISO 27001 Certified", description: "Enterprise-grade quality and security built into everything we deliver." },
        { icon: faCheckCircle, title: "Supporting Startups, SMBs & Enterprises", description: "Flexible, scalable, and cost-effective tech solutions for every growth stage." },
        { icon: faCheckCircle, title: "Global Reach with Local Impact", description: "We serve clients in 30+ countries, blending international perspective with market-specific insight." },
        { icon: faCheckCircle, title: "Rooted in Innovation & Client Success", description: "We build lasting relationships based on results, reliability, and forward-thinking execution." },
        { icon: faCheckCircle, title: "Highly Rated by Trusted Industry Platforms", description: "Recognized on Clutch, GoodFirms, TechBehemoths, TopDevelopers, and more." },
        { icon: faShieldAlt, title: "Enterprise-Grade Security", description: "Your data and digital assets are protected with industry-leading security standards." },
    ];
    // Why Webkorps Stands Out at INBOUND 2025
    const whyStandsOutData = [
        { icon: faBullseye, title: "Precision with Purpose", description: "We create tailored digital solutions that align with your unique marketing and growth objectives — delivering clarity, agility, and measurable results." },
        { icon: faUsers, title: "Strategic Partnerships", description: "We go beyond project delivery - building lasting partnerships that enable long-term success and sustainable digital transformation." },
        { icon: faBrain, title: "Future-Ready Expertise", description: "From AI-powered automation to CRM integration and customer journey optimization, we help you stay ahead of evolving trends and technologies." },
        { icon: faStar, title: "Proven Excellence", description: "With 500+ successful projects across industries, we have a proven track record of turning strategy into scalable, high-impact solutions." },
        { icon: faBolt, title: "Growth Through Collaboration", description: "We believe the best outcomes come from working together. At INBOUND, we're here to connect, collaborate, and co-create the future of marketing and customer experiences." },
    ];
    ...
    const OverviewData = [
        {
            para:
                "Webkorps is excited to bring its passion for innovation and digital transformation to INBOUND 2025, HubSpot’s premier event for marketing, sales, and customer experience leaders. As a trusted technology partner for growth-driven businesses, we’re here to showcase how smart tech and strategic solutions can unlock your next level.",
        },
        {
            para:
                "At INBOUND, we’ll be presenting our latest innovations in MarTech solutions, AI & Automation, CRM Integrations, Custom Web & App Development, Data-Driven Marketing Platforms, Cloud Services, and more — all designed to help businesses attract, engage, and delight customers at scale.",
        },
        {
            para:
                "Whether you're a startup aiming to disrupt, a scaling business refining your funnel, or an enterprise investing in long-term digital growth, Webkorps has the tools, talent, and tech to turn your vision into measurable success.",
        },
        {
            para:
                "Let’s connect at INBOUND 2025 — and shape the future of marketing and customer experience, together.",
        },
    ];
    ...
    const AboutData = [
        {
            para:
                "INBOUND 2025 is more than just a marketing and sales conference - it’s a global gathering of bold ideas, breakthrough strategies, and visionary leaders driving the future of customer engagement, growth, and digital transformation. Hosted by HubSpot, INBOUND brings together marketers, sales professionals, founders, and creatives from around the world to connect, learn, and inspire.",
        },
        {
            para:
                "From AI-powered marketing to CRM automation, customer journey innovation, content strategy, and RevOps, INBOUND is where emerging trends take center stage and tomorrow’s best practices are born.",
        },
        {
            para:
                "For Webkorps, INBOUND 2025 is more than an event - it’s a stage to collaborate, exchange ideas, and co-create smart digital solutions that empower brands to attract, engage, and retain customers in a fast-moving digital world.",
        },
    ];
    ...
    const features = {
        title: `Why Meet Webkorps at INBOUND 2025?`,
        description: "At Webkorps, we don’t just develop technology - we deliver intelligent, scalable, and secure digital solutions that empower modern businesses to grow smarter and connect better. Whether you're a fast-scaling startup or a mature enterprise redefining your customer experience, Webkorps brings the strategic innovation, technical expertise, and agility you need to succeed.",
        data: [
    ...
    return (
        <div className="overflow-hidden font-inter">
            <Helmet>
                <title>Meet Webkorps at INBOUND 2025 </title>
                <meta name="description" content="Join Webkorps at INBOUND 2025 to explore how technology powers smarter marketing, sales, and customer experiences. Discover innovative digital solutions and connect with our experts to accelerate your growth journey." />
                <meta property="og:url" content="https://www.webkorps.com/event/inbound" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Meet Webkorps at INBOUND 2025" />
                <meta property="og:description" content="Join Webkorps at INBOUND 2025 to explore how technology powers smarter marketing, sales, and customer experiences. Discover innovative digital solutions and connect with our experts to accelerate your growth journey" />
                <meta property="og:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/meet-webkorps-at-inbound.png" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:domain" content="webkorps.com" />
                <meta property="twitter:url" content="https://www.webkorps.com/event/inbound" />
                <meta name="twitter:title" content="Meet Webkorps at INBOUND 2025" />
                <meta name="twitter:description" content="Join Webkorps at INBOUND 2025 to explore how technology powers smarter marketing, sales, and customer experiences. Discover innovative digital solutions and connect with our experts to accelerate your growth journey" />
                <meta name="twitter:image" content="https://webkorps-app.s3.us-east-1.amazonaws.com/meet-webkorps-at-inbound.png" />
                <link data-rh="true" rel="canonical" href="https://www.webkorps.com/event/inbound" />
            </Helmet>
            <div className="w-full text-center xl:text-left ipad-pro:text-left md:text-center ">
                <EventHeroSectionUI
                    title={'Meet Webkorps At INBOUND 2025'}
                    subtitle={"HubSpot's Premier Marketing & Growth Event"}
                    date={formattedDate}
                    location={`San Francisco's Moscone Center`}
                    image={logoImage}
                ...
                <div className="flex flex-col overflow-hidden md:flex-col ipad-pro:flex-row xl:flex-row items-center xl:items-stretch px-[3%] xl:px-[30px] ipad-pro:px-[30px] justify-center text-center lg:text-left  mx-[7%] md:mx-[7%] xl:mx-[50px] ipad-pro:mx-[50px] justify-center p-12 shadow-custom-lg rounded-[20px] bg-white gap-[60px]">
                    ...
                    <div className="content flex flex-col">
                        <h2
                            ...
                            data-aos="fade-right"
                            dangerouslySetInnerHTML={{ __html: "Webkorps is Ready for INBOUND 2025 - San Francisco" }}
                        >
                    ...
                    <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                        <img
                            ...
                            loading="lazy"
                            src='https://webkorps-app.s3.us-east-1.amazonaws.com/webkorps-is-ready-for-inbound.jpg'
                    ...
                    <div className="flex overflow-hidden flex-col ipad-pro:flex-row  md:flex-col xxl:gap-[10%] xl:gap-[125px] md:gap-[30px]  xl:flex-row items-start md:items-start ">
                        <div className="content mt-6 xl:mt-0 ipad-pro:mt-6 md:mt-6 w-full flex flex-col items-center xl:items-end ipad-pro:items-end md:items-center">
                            <img
                                ...
                                sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 33vw"
                                loading="lazy"
                                src='https://webkorps-app.s3.us-east-1.amazonaws.com/shaping-the-future-at-inbound.jpg'
                                alt="leading-web-development-company"
                                className="rounded-lg shadow-md w-full lg:w-[385px] h-full max-w-md"
                                data-aos="fade-left"
                            />
            ...
            <div className="w-full flex flex-col items-center justify-center py-12 bg-white px-[7%] md:px-[7%] xl:px-[50px]">
                <div className="flex flex-col items-center justify-center text-center  p-12 shadow-custom-lg rounded-[20px] bg-white ">
                    <div className="content  w-full  text-[#292E3D]">
                        ...
                        >
                            The Value Webkorps Brings to INBOUND 2025
                        </h2>
                    </div>
                    <div className="w-full flex justify-center">
                        <div className="flex flex-wrap justify-center gap-8 max-w-8xl">
                            ...
                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                ...
                                <h3 className="font-bold text-lg mb-2">Tailored Solutions for Growth-Driven Brands</h3>
                                <p className="text-[#4B5563] text-base">We specialize in creating smart, scalable digital solutions that solve real-world marketing, sales, and customer experience challenges, delivering measurable business outcomes that last.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faUsers} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Collaboration That Fuels Innovation</h3>
                                <p className="text-[#4B5563] text-base">We work hand-in-hand with our clients to co-create impactful solutions. Our collaborative approach empowers brands to innovate faster, engage better, and scale smarter.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faBolt} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Strategic Vision Meets Actionable Execution</h3>
                                <p className="text-[#4B5563] text-base">We bridge the gap between strategic vision and practical implementation, enabling businesses to stay competitive and agile in a fast-evolving digital landscape.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faGlobe} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Trusted Global Expertise</h3>
                                <p className="text-[#4B5563] text-base">With a strong footprint across global events like INBOUND, GITEX, CES, and IndiaSoft, Webkorps brings a world of insight to every engagement, grounded in real success stories.</p>
                            </div>

                            <div className="bg-white border rounded-xl p-6 flex flex-col items-center shadow w-[350px]">
                                <FontAwesomeIcon icon={faMedal} className="text-[#1887C9] text-4xl mb-4" />
                                <h3 className="font-bold text-lg mb-2">Excellence from Strategy to Delivery</h3>
                                <p className="text-[#4B5563] text-base">From discovery to deployment, we deliver future-ready solutions that elevate marketing performance, enhance customer journeys, and drive meaningful business growth.</p>
                            </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-8 shadow-custom-lg rounded-[20px] bg-white">
                    <div className="content mx-auto w-full  text-[#292E3D]">
                        ...
                        >
                            What We're Showcasing at <span className="text-[#1887C9]">INBOUND 2025</span>
                        </h2>
                    </div>
            ...
            <div className="py-[4rem] bg-[#061C3D] font-inter">
                <div className="flex flex-col items-center justify-center text-center mx-[7%] md:mx-[7%] xl:mx-[50px] p-12 shadow-custom-lg rounded-[20px] bg-white gap-y-8">
                    <h2 className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                    >
                        Why Meet Webkorps at <span className="text-[#1887C9]">INBOUND 2025?</span>
                    </h2>
                    ...
                    <p className="max-w-3xl mx-auto text-gray-700 text-lg font-semibold ">
                        Let's connect at INBOUND 2025 to explore how Webkorps can help you scale your marketing, enhance customer experiences, and drive measurable success.
                    </p>
                    <a
                        href={BtnLink}
                        target="_blank"
            ...
            <div className="py-[4rem] bg-[#D3D3D3]">
                <div className="mx-[7%] md:mx-[7%] xl:mx-[50px] p-12 shadow-custom-lg rounded-[20px] bg-white text-center">
                    <h2 className=" font-bold text-[20px] md:text-[33px] xl:text-[40px]  ipad-pro:text-[37px] md:text-[36px] leading-7 md:leading-[46.2px] xl:leading-[50px] text-[#000000]"
                    >
                        Why Webkorps Stands Out at <span className="text-[#1887C9]">INBOUND 2025</span>
                    </h2>
                    <p className="mt-4 text-lg text-gray-600 max-w-4xl mx-auto">
                        At Webkorps, we fuse innovation, strategic thinking, and deep technical expertise to deliver solutions that drive meaningful business outcomes. As we join industry leaders at INBOUND 2025, we invite you to experience how our approach goes beyond solving problems - it reimagines what's possible in a connected, customer-centric world.
                    </p>
                    <div className="w-full flex justify-center mt-8">
                        <div className="flex flex-wrap justify-center gap-8 max-w-8xl">
